...
intended as **a simpler scripting language for websites**, complementing the use of Java for more complex web applications, but its **tight integration with Web pages and built-in support in browsers** has caused it to become far more common than Java in web frontends.
...
the similarity in name, JavaScript's **object model is significantly different** to Java's.
